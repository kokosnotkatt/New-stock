    ...
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Left Column - News Feed (ที่แก้ Font Hierarchy แล้ว) */}
                    ...
                    <div className="p-5">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2 text-xs text-gray-500">
                          <span className="font-medium text-gray-700">{article.company}</span>
                          <span>•</span>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 sticky top-20">
              ...
              {watchlist.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <button className="mt-4 px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors"> {/* <-- แก้ไข */}
                    เพิ่มหุ้นติดตาม
                  </button>
                </div>
              )}
